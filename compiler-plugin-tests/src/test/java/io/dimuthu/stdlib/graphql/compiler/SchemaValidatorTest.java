...
import static io.dimuthu.stdlib.graphql.compiler.Utils.getSchemaObject;
...
public class SchemaValidatorTest {
    ...
    public void testSchemaLocationDetailsAndObjectKind() {
        ...
        io.dimuthu.stdlib.graphql.commons.types.Position classPos = schema.getType("Elephant").getPosition();
        ...
        io.dimuthu.stdlib.graphql.commons.types.Position recordPos = schema.getType("Lion").getPosition();
        ...
        // Enum
        io.dimuthu.stdlib.graphql.commons.types.Position enumPos = schema.getType("Weekday").getPosition();
