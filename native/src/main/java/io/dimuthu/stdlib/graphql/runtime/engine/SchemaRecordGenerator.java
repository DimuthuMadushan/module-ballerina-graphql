...
import io.dimuthu.stdlib.graphql.commons.types.DirectiveLocation;
...
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.ARGS_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.DEFAULT_VALUE_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.DEPRECATION_REASON_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.DESCRIPTION_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.DIRECTIVES_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.DIRECTIVE_LOCATION_ENUM;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.DIRECTIVE_RECORD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.ENUM_VALUES_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.ENUM_VALUE_RECORD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.FIELDS_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.FIELD_RECORD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.INPUT_FIELDS_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.INPUT_VALUE_RECORD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.INTERFACES_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.IS_DEPRECATED_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.KIND_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.LOCATIONS_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.MUTATION;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.MUTATION_TYPE_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.NAME_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.OF_TYPE_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.POSSIBLE_TYPES_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.QUERY;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.QUERY_TYPE_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.SCHEMA_RECORD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.SUBSCRIPTION;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.SUBSCRIPTION_TYPE_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.TYPES_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.TYPE_FIELD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.TYPE_RECORD;
import static io.dimuthu.stdlib.graphql.runtime.engine.EngineUtils.getArrayTypeFromBMap;
